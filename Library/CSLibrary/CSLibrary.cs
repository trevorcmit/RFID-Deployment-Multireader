...
namespace CSLibrary {
    public partial class HighLevelInterface {
        ...
        private READERSTATE _reader1State = READERSTATE.DISCONNECT;
        public READERSTATE Status {get {return _reader1State;}}
        ...
        void ExecuteFinishBLETask() {
            if (_afterFinishBLETask == null) return;
        ...
        void TimerFunc(object o) {
            if (_reader1State == READERSTATE.READYFORDISCONNECT || _reader1State == READERSTATE.DISCONNECT) {
                BTTimer.Cancel();
                _sendBuffer.Clear();
                _NeedCommandResponseType = BTWAITCOMMANDRESPONSETYPE.NOWAIT;
                _reader1State = READERSTATE.DISCONNECT;
                return;
            }
